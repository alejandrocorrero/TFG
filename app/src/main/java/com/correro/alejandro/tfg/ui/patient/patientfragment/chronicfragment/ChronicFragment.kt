...
class ChronicFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        view.rcyChronics.adapter = ChronicAdapter(mviewmodel.chronics, clickItem())
        return view
    }

    private fun clickItem(): (Chronic) -> Unit {
        return {
            Toast.makeText(activity, it.nombre, Toast.LENGTH_SHORT).show()
        }
    }
}
