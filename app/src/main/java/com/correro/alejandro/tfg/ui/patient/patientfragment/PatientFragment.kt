        ...
        if (pref.getInt(Constants.TYPE_CONSTAN, 0) == 2) {
            ...
            mviewmodel.status.observe(this, Observer {
                ...
                mviewmodel.userMedic.observe(this, Observer {
                    ...
                    Picasso.get().load(Constants.ADDRESS+"uploads/adjuntos/" + it.foto).into(viewgroup.imgPhoto);
            ...
            Picasso.get().load(Constants.ADDRESS+"uploads/adjuntos/" + mviewmodel.user.foto).into(viewgroup.imgPhoto);
        }
